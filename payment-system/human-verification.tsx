  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-8">
        {/* Main heading */}
        <h1 className="text-2xl font-normal text-orange-500">
        ...
        {/* Begin button */}
        <Button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-2 rounded font-medium" size="default">
          Begin
